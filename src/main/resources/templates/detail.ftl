            ...
            <div id="comments" class="comments">
                ...
                <div class="media">
                    ...
                    <div class="media-body">
                        ...
                        <h4 class="media-heading"> ${commentvo.user.name} <small class="date">${commentvo.comment.createdDate?string("yyyy-MM-dd")!""}</small>
                        <#if loginer??>
                            <#if loginer.id == commentvo.user.id>
                            <a href="/deleteComment?id=${commentvo.comment.id}">删除评论</a>
                            </#if>
                        </#if>
